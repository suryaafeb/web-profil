...
//hapus jenjang
$sql_dh = "delete from `master_jenjang`
            ...
            <div class="card">
              ...
              <div class="col-sm-12">         
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                    $sql_j = "SELECT `id_master_jenjang`, `jenjang` FROM `master_jenjang` ORDER BY `jenjang`";
                    ...
                    <tr>
                      ...
                      <td align="center">
                      <a href="editjenjang.php?data=<?php echo
                      $id_master_jenjang;?>"
                      class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
                      <a href="javascript:if(confirm('Anda yakin ingin menghapus data
                      <?php echo $jenjang; ?>?'))window.location.href =
                      'jenjang.php?aksi=hapus&data=<?php echo
                      $id_master_jenjang;?>&notif-hapusberhasil'"
